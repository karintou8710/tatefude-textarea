...
import { CanvasVertTextarea } from "../../src/editor";
import type { CanvasVertTextareaOptions } from "../../src/types";
...
function setup(options: CanvasVertTextareaOptions = {}) {
  const container = document.createElement("div");
  Object.assign(container.style, { width: "300px", height: "200px" });
  document.body.appendChild(container);

  const editor = new CanvasVertTextarea(container, {
...
describe("外から触る", () => {
  ...
  it("destroy で canvas も textarea も消える", () => {
